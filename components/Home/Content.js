 ...
 * @LastEditTime: 2022-09-19 18:49:32
...
const Content = () => {
  return (
    <div className={`${styls.content} ${utilStyles.plain}`}>
      <article>
        <p>
          🎉Hey, I&apos;m Li Ziming, a sophomore at{' '} Jinan
          , majoring in{' '}
        ...
        Can't go to the concert at the moment 😢
        </p>
      </article>
      <Divider />
      <article>
        ...
        <p>Some of my projects: [bookStore] | [Next_React] On my way ...</p>
      </article>
      <Divider />
      <article>
        <p>
          In my spare time, I like watching Bilibili . By accident
          share some opinions and experience. You can find me
          on <span className={utilStyles.stress}>哔哩哔哩</span> by searching
          哈哈hhhhh_ (this nickname is so cute) or clicking{' '}
          <a
